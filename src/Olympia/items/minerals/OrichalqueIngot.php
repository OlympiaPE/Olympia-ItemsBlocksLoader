...
final class OrichalqueIngot extends Item implements ItemComponents
{
    ...
    public function __construct(ItemIdentifier $identifier, string $name)
    {
        ...
        $this->initComponent("orichalque_ingot", $creativeInfo);
        $this->addComponent(new MaxStackSizeComponent(64));
        $this->setCustomName("§r§fLingot d'orichalque");
